      ...
      <div>
        <Carousel autoplay className="custom-carousel">
          <div>
            <div>
              ...
              <Row type="flex" gutter={48} justify="space-around">
                <Col span={24}>
                  <Button type="primary" icon="github" href="https://github.com/bk313131/ReactAntPWAWebsiteExample">
                    View source code
                  </Button>
                </Col>
              </Row>
          ...
          <div>
            ...
            <Row type="flex" gutter={48} justify="space-around">
              <Col span={24}>
                <Button type="primary" icon="global" href="https://github.com/bk313131">
                  Visit Github
                </Button>
              </Col>
            </Row>
